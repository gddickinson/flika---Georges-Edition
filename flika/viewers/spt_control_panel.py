...
from flika.utils.ui_components import (
...
class SPTControlPanel(QtWidgets.QDockWidget):
    ...
    def _on_detect(self):
        ...
        try:
            ...
            if method == 'U-Track':
                ...
                try:
                    from flika.ai.particle_localizer import ParticleLocalizer
    ...
    def _on_link(self):
        ...
        try:
            if method == 'Greedy':
                ...
                from flika.spt.linking.utrack_linker import (
    ...
    def _run_single_file(self, file_path, output_dir):
        ...
        # Load image data
        from flika.io.registry import FormatRegistry
