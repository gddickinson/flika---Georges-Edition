...
class SimulationDialog(QtWidgets.QDialog):
    ...
    def _build_sample_tab(self):
        ...
        sec_dyn.addRow("D (µm²/s):", self._diffusion_coeff)
    ...
    def _build_microscope_tab(self):
        ...
        sec_cam.addRow("Pixel size (µm):", self._cam_pixsize)
