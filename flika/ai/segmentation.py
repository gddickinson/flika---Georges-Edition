...
class AIDenoiser:
    ...
    def gui(self):
        from .training_dialog import DenoiserDialog
...
class AIPixelClassifier:
    ...
    def gui(self):
        from .classifier_dialog import PixelClassifierDialog
...
class AIParticleLocalizer:
    ...
    def gui(self):
        from .localizer_dialog import ParticleLocalizerDialog
...
class BioImageIORunner:
    ...
    def gui(self):
        from .model_zoo import ModelZooBrowser
...
class AISAMSegmenter:
    ...
    def gui(self):
        from .sam_dialog import SAMSegmentationDialog
