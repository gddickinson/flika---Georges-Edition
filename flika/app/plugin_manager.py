...
class PluginManager(QtWidgets.QMainWindow):
    ...
    def pluginSelected(self, item):
        ...
        latest_version = Version(plugin.latest_version)
        ...
        elif Version(plugin.version) < Version(plugin.latest_version):
    ...
    def showPlugins(self, search_str=None):
        ...
        for name in names:
            ...
            elif Version(plug.version) < Version(plug.latest_version):
...
class PluginDescriptor:
    ...
    startup stays fast.
    """
    __slots__ = ('name', 'directory', 'version', 'author', 'path', 'menu_layout', 'dependencies')
