...
class LocalizerPredictionWorker(QtCore.QThread):
    ...
    def run(self):
        try:
            from .psf_simulator import PSFSimulator
    ...
    def _run_tracking(self, localizations):
        ...
        try:
            from ..utils.tracking import link_particles, tracks_to_array
...
class ParticleLocalizerDialog(QtWidgets.QDialog):
    ...
    def _build_config(self):
        from .localizer_backends import LocalizerConfig
        try:
    ...
    def _start_simulation(self, config):
        ...
        from .psf_simulator import PSFConfig
    ...
    def _on_sim_done(self, images, density_maps):
        ...
        from .localizer_backends import create_backend
