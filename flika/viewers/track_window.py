...
class TrackDetailWindow(QtWidgets.QWidget):
    ...
    def _update_panel_2(self):
        ...
        try:
            from ..spt.features.kinematic import distance_from_origin
    ...
    def _update_panel_4(self):
        ...
        try:
            from ..spt.features.spatial import nearest_neighbor_distances
        except ImportError:
    ...
    def _update_panel_5(self):
        ...
        try:
            from ..spt.features.kinematic import velocity_analysis
    ...
    def _update_summary(self):
        ...
        if not feat and self._xy is not None and len(self._xy) >= 3:
            try:
                from ..spt.features.geometric import radius_of_gyration
                rg_result = radius_of_gyration(self._xy)
                parts.append(f"Rg={rg_result['rg']:.2f}")
            except Exception:
                pass
            try:
                from ..spt.features.kinematic import msd_analysis
