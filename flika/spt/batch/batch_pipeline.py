...
class SPTBatchPipeline:
    ...
    def _make_detector(self):
        ...
        if p.detector == 'thunderstorm':
            from flika.detection.thunderstorm import ThunderSTORMDetector
            ...
            from flika.detection.utrack_detector import UTrackDetector
    ...
    def _link(self, locs):
        ...
        if p.linker == 'trackpy':
            from flika.linking.trackpy_linker import link_with_trackpy
            ...
            from flika.linking.utrack_linker import UTrackLinker
            linker = UTrackLinker(
            ...
            from flika.linking.greedy_linker import link_particles
    ...
    def _compute_features(self, locs, tracks):
        ...
        """
        from flika.features.feature_calculator import FeatureCalculator
    ...
    def _classify(self, features_df):
        ...
        try:
            if self._classifier is None:
                from flika.classification.svm_classifier import SPTClassifier
    ...
    def _autocorrelation(self, tracks_dict):
        ...
        try:
            from flika.features.autocorrelation import AutocorrelationAnalyzer
    ...
    def run_on_window(self, window, callback=None):
        ...
        if self.params.enable_autocorrelation and tracks:
            ...
            from flika.linking.greedy_linker import tracks_to_dict
    ...
    def _save_results(self, output_dir, basename, locs, tracks,
        ...
        from flika.io.spt_formats import (write_localizations,
                                      write_features,
                                      write_analysis_metadata)
        from flika.linking.greedy_linker import tracks_to_array
