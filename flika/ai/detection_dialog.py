...
from flika.ai.annotations import AnnotationClass, AnnotationSet, BoundingBox
from flika.ai.annotation_overlay import BoxAnnotationOverlay, InteractionMode
from flika.ai.detection_backend import DetectionConfig, UltralyticsBackend, prepare_image_for_detection
...
class ObjectDetectionDialog(QtWidgets.QDialog):
    ...
    def _build_train_tab(self) -> QtWidgets.QWidget:
        ...
        # Save location info
        from flika.ai.detection_backend import _models_dir
